...
func (real *IsReal) SetCacheData(rcd []RealCacheData) {
...
func (real *IsReal) GetCacheData(res *Result) {
...
func (real *IsReal) GetRealData() []RealCacheData {
...
func (real *IsReal) SetDataCacheKey(dck []DataCacheKey) {
	real.dck = RemoveDuplicateElement(dck)
}
func (real *IsReal) DelCacheData() {
...
func (real *IsReal) GetCacheKey(key DataCacheKey) string {
